...
const germanQuestions: Question[] = [
  {
    id: 1,
...
const italianQuestions: Question[] = [
  {
    id: 1,
...
const slovakQuestions: Question[] = [
  {
    id: 1,
...
export function getQuestionsForLanguage(languageCode: string): Question[] {
  return questionsByLanguage[languageCode] || englishQuestions;
}

export { questionsByLanguage };