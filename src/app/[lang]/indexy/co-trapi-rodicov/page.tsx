...
export default function Page({ params }: { params: { lang: string } }) {
  ...
  return (
    <Container>
      <Breadcrumbs items={[{ href: `/${lang}`, label: 'Domov' }, { href: `/${lang}/indexy`, label: 'Indexy' }, { label: 'Čo trápi rodičov' }]} />
      <h1 className="text-3xl font-semibold mt-4">{fm?.title || 'Čo trápi rodičov'}</h1>
