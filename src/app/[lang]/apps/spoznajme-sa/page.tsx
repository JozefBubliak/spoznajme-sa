...
export default function Page({ params }: { params: { lang: string } }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 space-y-10">
      <Link href={back} className="text-sm text-muted-foreground hover:underline">← Späť na Konverzačné hry</Link>
      ...
      <section id="how" className="grid md:grid-cols-3 gap-6">
        <div className="rounded-xl border p-5"><h3 className="font-medium">1. Vyber režim</h3><p className="text-sm text-muted-foreground mt-1">Otvárače, Hlbšie, Spomienky, Zábavné.</p></div>
        <div className="rounded-xl border p-5"><h3 className="font-medium">2. Hrajte v mobile</h3><p className="text-sm text-muted-foreground mt-1">Každá karta je jasná a priateľská. Vždy sa dá preskočiť.</p></div>
        <div className="rounded-xl border p-5"><h3 className="font-medium">3. Ulož obľúbené</h3><p className="text-sm text-muted-foreground mt-1">Vráť sa k nim nabudúce alebo ich zdieľaj.</p></div>
      </section>
