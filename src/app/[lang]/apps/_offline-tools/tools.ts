...
export const OFFLINE_TOOLS: Record<string, OfflineTool> = {
  ...
  'rozbi-rutinu': {
    ...
    icon: '💥',
    title: 'Rozbi rutinu',
    subtitle: 'Konkrétne zásahy do rutiny — od 5 minút po adrenalín a odhalenie sa. Žiadne „urob si selfie". Telefón ukáže výzvu a ide bokom.',
    theme: 'from-purple-600 to-fuchsia-600',
    bg: 'from-purple-50 via-fuchsia-50 to-pink-50',
    button: 'from-purple-600 to-fuchsia-600',
    emptyText: 'Vyber úroveň a nechaj si vylosovať výzvu na dnes.',
    primaryAction: 'Vylosuj výzvu',
    nextAction: 'Ďalšia výzva',
    filters: [
      { key: 'all', label: 'Všetky' },
      { key: 'mikro', label: '⏱️ Mikro (5–15 min)' },
      { key: 'vecer', label: '🌙 Večer inak' },
      { key: 'vikend', label: '🧭 Víkend' },
      { key: 'adrenalin', label: '🪂 Adrenalín' },
      { key: 'nahrane', label: '🔥 Na hrane (odhaliť sa)' },
    ],
    items: [
      // ── MIKRO ──────────────────────────────────────────────
      { cat: 'mikro', emoji: '🔁', title: 'Výmena telefónov', desc: 'Na dnešný večer si vymeňte telefóny. Ak niekomu napíšu, odpovedáš zaňho (slušne).', why: 'Zistíš, ako partner komunikuje s inými — a ako to vyzerá „zvonku".' },
      { cat: 'mikro', emoji: '🍽️', title: 'Večera poslepiačky', desc: 'Jeden zaviaže druhému oči a nakŕmi ho. Potom vymeňte.', steps: ['Pripravte pár malých vecí na tanieri.', 'Zaviažte oči šatkou.', 'Bez slov — len podávajte a hádajte, čo to je.'], why: 'Keď vypadne zrak, dôvera a pozornosť idú hore.' },
      { cat: 'mikro', emoji: '🌑', title: 'Rozhovor v tme', desc: 'Choďte spať o hodinu skôr. Žiadne telefóny. Rozprávajte sa potme, kým nezaspíte.', why: 'V tme sa ľudia pýtajú veci, ktoré cez deň obídu.' },
      { cat: 'mikro', emoji: '📞', title: 'Spoločný telefonát', desc: 'Zavolajte spolu, na hlasitý odposluch, niekomu, na koho ste obaja dlho nemysleli.', why: 'Spoločné „ahoj, len sme si spomenuli" zblíži viac než hodina plánovania.' },
      { cat: 'mikro', emoji: '📝', title: 'Tri veci na tento rok', desc: 'Každý napíše 3 veci, ktoré chce tento rok zažiť. Vymeňte zoznamy. Jednu z partnerovho naplánujte do 14 dní.', steps: ['Píšte oddelene, 5 minút.', 'Vymeňte papieriky.', 'Vyberte jednu z partnerovho a hneď dohodnite dátum.'] },
      { cat: 'mikro', emoji: '🖼️', title: 'Päť nevidených fotiek', desc: 'Ukážte si navzájom 5 fotiek z telefónu, ktoré ste nikdy nezdieľali, a povedzte, prečo práve tie.', why: 'To, čo si fotíme sami pre seba, hovorí viac než feed.' },
      { cat: 'mikro', emoji: '🪑', title: 'Presunúť nábytok', desc: '20 minút: presuňte nábytok v jednej izbe. Aj keď ho potom vrátite.', why: 'Fyzická spolupráca na niečom malom „resetuje" atmosféru.' },
      { cat: 'mikro', emoji: '✉️', title: 'List na o rok', desc: 'Napíšte partnerovi krátky list, ktorý si prečíta presne o rok. Zalepte, napíšte dátum, schovajte.' },
      { cat: 'mikro', emoji: '🤫', title: 'Večera bez slov', desc: 'Celú večeru komunikujete len gestami, pohľadmi a dotykmi. Kto prehovorí, umýva riad.' },
      { cat: 'mikro', emoji: '📲', title: 'Nová správa', desc: 'Napíšte si navzájom SMS tak, akoby ste sa práve prvýkrát spoznali a chceli sa vidieť.' },
      { cat: 'mikro', emoji: '🏅', title: 'Päť minút len komplimenty', desc: 'Časovač na 5 minút. Striedavo si hovoríte konkrétne veci, ktoré na sebe oceňujete. Nič iné.' },
      { cat: 'mikro', emoji: '🔒', title: 'Telefóny do zásuvky', desc: 'Zamknite obom telefóny do zásuvky (alebo dajte kľúč susedovi) na jednu hodinu. Čo urobíte s časom navyše?' },
      { cat: 'mikro', emoji: '🪄', title: 'Trik za 15 minút', desc: 'Naučte sa spolu z videa jeden kúzelnícky alebo kartový trik a predveďte ho ešte dnes niekomu tretiemu.', why: 'Spoločné „trápne učenie sa" prelomí atmosféru rýchlejšie než vážny rozhovor.' },

      // ── VEČER INAK ─────────────────────────────────────────
      { cat: 'vecer', emoji: '🕯️', title: 'Večer bez elektriny', desc: 'Vypnite svetlá aj obrazovky. Len sviečky. Uvidíte, čo z večera ostane, keď zmizne rozptýlenie.' },
      { cat: 'vecer', emoji: '🔄', title: 'Vymenené roly', desc: 'Na celý večer si vymeňte, kto čo robí. Kto nikdy nevaria, varí. Kto nikdy neplánuje, plánuje celý večer.', why: 'Zistíš, koľko „neviditeľnej práce" partner bežne nesie.' },
      { cat: 'vecer', emoji: '🍷', title: 'Reštaurácia doma', desc: 'Jeden je čašník, druhý hosť — menu, sviečka, obsluha. Po hlavnom chode vymeňte roly.' },
      { cat: 'vecer', emoji: '💿', title: 'Album od začiatku do konca', desc: 'Pustite album, ktorý mal pre jedného z vás v mladosti význam. Celý. Bez telefónov, len počúvať.', why: 'Hudba z minulosti otvorí spomienky, ku ktorým sa inak nedostanete.' },
      { cat: 'vecer', emoji: '⏲️', title: 'Tri x dvadsať minút', desc: '20 minút čo chce ona, 20 čo chce on, 20 čo ste nikdy neskúsili. Časovač rozhoduje.' },
      { cat: 'vecer', emoji: '💃', title: 'Tanec v kuchyni', desc: 'Jedna pieseň, žiadni diváci, žiadne pravidlá. Aj keď neviete tancovať. Hlavne vydržte do konca skladby.' },
      { cat: 'vecer', emoji: '🎙️', title: 'Interview', desc: 'Jeden má 20 minút a pýta sa druhého na čokoľvek. Potom vymeňte. Žiadna otázka nie je zakázaná, žiadna odpoveď povinná.' },
      { cat: 'vecer', emoji: '📋', title: 'Zoznam automatizmov', desc: 'Napíšte spolu 10 vecí, ktoré robíte na autopilota. Jednu z nich dnes večer urobte úplne inak.' },
      { cat: 'vecer', emoji: '🎰', title: 'Päť surovín naslepo', desc: 'Jeden poslepiačky vyberie 5 surovín z chladničky a špajze. Z nich musí druhý uvariť večeru.', steps: ['Zaviažte oči a vyberte 5 vecí.', 'Žiadna výmena.', 'Kuchár má 30 minút.'] },
      { cat: 'vecer', emoji: '📺', title: 'Film bez zvuku', desc: 'Pustite film, stlmte zvuk a celý ho nadabujte sami. Čím absurdnejšie dialógy, tým lepšie.' },
      { cat: 'vecer', emoji: '🕹️', title: 'Retro večer', desc: 'Telefóny do zásuvky. Karty, spoločenská hra alebo hlavolam pri sviečke — večer, ako keby elektronika neexistovala.' },
      { cat: 'vecer', emoji: '🔦', title: 'Horúce – studené', desc: 'Jeden schová v byte drobnosť. Druhý ju hľadá len podľa „horúco / studeno". Potom vymeňte.' },
      { cat: 'vecer', emoji: '⏳', title: 'My o 10 rokov', desc: 'Napíšte spolu list vašim „ja o 10 rokov" — čo im chcete odkázať, na čo nezabudnúť. Zalepte a schovajte.' },

      // ── VÍKEND ─────────────────────────────────────────────
      { cat: 'vikend', emoji: '🪙', title: 'Mincový výlet', desc: 'Sadnite do auta. Na každej križovatke hodíte mincou (hlava vľavo, znak vpravo). Po 60 minútach zastavte a nájdite tam kávu alebo obed.' },
      { cat: 'vikend', emoji: '🎬', title: 'Prvé rande 2.0', desc: 'Zopakujte svoje prvé rande — rovnaké miesto, ak sa dá. Ale tentokrát sa spýtajte 3 veci, na ktoré ste sa vtedy nespýtali.' },
      { cat: 'vikend', emoji: '💸', title: 'Deň bez peňazí', desc: 'Von ísť môžete, ale nesmiete nič kúpiť. Prechádzka, knižnica, park, doma jedlo z toho, čo máte.', why: 'Bez „kúpme si niečo" musíte vymyslieť, ako spolu tráviť čas.' },
      { cat: 'vikend', emoji: '🔑', title: 'Deň v cudzej koži', desc: 'Na 24 hodín si vymeňte jednu vec, ktorú vždy robí ten druhý — financie, budík, výber jedla, riadenie.' },
      { cat: 'vikend', emoji: '📍', title: 'Biele miesto na mape', desc: 'Nájdite miesto vo vašom meste, kde ste nikdy neboli, hoci okolo prechádzate roky. Choďte tam.' },
      { cat: 'vikend', emoji: '🎁', title: 'Dvojité prekvapenie', desc: 'Naplánujte prekvapenie jeden pre druhého na rovnaký deň. Ani jeden nevie, čo chystá ten druhý. Večer si to „doručte".' },
      { cat: 'vikend', emoji: '🚆', title: 'Vlak nikam', desc: 'Choďte vlakom do najbližšieho mesta, kde nemáte dôvod ísť. Bez itinerára, bez rezervácie. Vráťte sa, keď budete chcieť.' },
      { cat: 'vikend', emoji: '📜', title: 'Bucket list deň', desc: 'Každý napíše 5 vecí. Vylosujete 2 (jednu od každého) a v ten deň ich naozaj spravíte.' },
      { cat: 'vikend', emoji: '🗺️', title: 'Prst na mape', desc: 'Rozložte mapu, zavrite oči, pichnite prstom. Ak je to do 2 hodín cesty, dnes tam idete.' },
      { cat: 'vikend', emoji: '🎒', title: 'Deň offline', desc: 'Celý deň bez internetu. Papierová mapa, hotovosť, žiadny telefón. Len vy dvaja a to, čo nájdete.' },
      { cat: 'vikend', emoji: '🎨', title: 'Výmena záľub', desc: 'Každý vezme toho druhého robiť to, čo baví jeho — jeho ranná bežecká trasa, jej keramika, jeho rybačka. Naozaj, celé.' },
      { cat: 'vikend', emoji: '⛺', title: 'Noc mimo postele', desc: 'Prespite jednu noc pod stanom — kľudne aj na balkóne alebo v záhrade. Zmena miesta na spanie mení aj rozhovory pred zaspaním.' },
      { cat: 'vikend', emoji: '📮', title: 'Turisti vo vlastnom meste', desc: 'Kúpte si pohľadnicu, choďte na miestnu pamiatku, dajte si to, čo dávajú turistom. Pozerajte sa na svoje mesto ako cudzinci.' },

      // ── ADRENALÍN ──────────────────────────────────────────
      { cat: 'adrenalin', emoji: '🧊', title: 'Skok do studenej vody', desc: 'Spolu do jazera, rieky alebo studeného mora. Naraz, na tri. Kto zaváha, platí kávu.', why: 'Chlad + zdieľaný šok = okamžitý spoločný adrenalín a smiech.' },
      { cat: 'adrenalin', emoji: '🌄', title: 'Východ z vrchu', desc: 'Vyjdite pešo na najvyšší bod v okolí pred svitaním a pozerajte východ slnka zhora. Nech je počasie akékoľvek.' },
      { cat: 'adrenalin', emoji: '🧗', title: 'Jeden istí druhého', desc: 'Zapíšte sa spolu na lezeckú stenu, viaferratu alebo zoslanenie. Doslova držíte jeden druhého na lane.', why: 'Fyzická dôvera „nepustíš ma" prenáša do vzťahu viac, než si myslíš.' },
      { cat: 'adrenalin', emoji: '🌲', title: 'Les bez baterky', desc: 'Krátky známy chodník v noci, bez svetla. Držte sa za ruky, spoľahnite sa na oči a na seba.' },
      { cat: 'adrenalin', emoji: '🪂', title: 'Zapíšte si termín', desc: 'Tandemový zoskok, bungee alebo paragliding. Dnes nájdite prevádzku a rezervujte konkrétny dátum — nie „niekedy".' },
      { cat: 'adrenalin', emoji: '😰', title: 'Čoho sa jeden bojí', desc: 'Vyberte niečo, čoho sa jeden z vás bojí — výška, hĺbka, jaskyňa, tma. Druhý je celý čas fyzicky pri ňom.' },
      { cat: 'adrenalin', emoji: '🏎️', title: 'Prvýkrát to skúste', desc: 'Rafting, motokáry, zorbing, trampolínový park, wakeboard. Vyberte, čo ste nikdy neskúsili, a choďte tento mesiac.' },
      { cat: 'adrenalin', emoji: '✨', title: 'Bivak pod hviezdami', desc: 'Jedna noc vonku len s karimatkou a spacákom, bez stanu. Zaspávate pod otvorenou oblohou.' },
      { cat: 'adrenalin', emoji: '👣', title: 'Kilometer naboso', desc: 'Prejdite spolu kus lesa alebo lúky bosí. Sústreďte sa len na to, čo cítite pod nohami — a mlčte.' },

      // ── NA HRANE ───────────────────────────────────────────
      { cat: 'nahrane', emoji: '🙏', title: 'Nevyslovené ďakujem', desc: 'Povedzte si navzájom jednu vec, za ktorú ste partnerovi nikdy nepoďakovali — a mali by ste.' },
      { cat: 'nahrane', emoji: '✋', title: 'Ukáž mi, ako', desc: 'Bez slov veďte partnerove ruky a ukážte, ako by ste chceli byť objímaní alebo bozkávaní. Potom vymeňte.' },
      { cat: 'nahrane', emoji: '🗒️', title: 'Papierik do spálne', desc: 'Každý napíše jednu vec, ktorú by chcel v spálni skúsiť. Zložte, vymeňte, prečítajte nahlas. Prvých 10 sekúnd žiadny komentár.' },
      { cat: 'nahrane', emoji: '👁️', title: 'Štyri minúty do očí', desc: 'Pozerajte sa jeden druhému 4 minúty do očí, bez slova. Potom si povedzte, čo to s vami spravilo.', why: 'Overený experiment psychológa Arona — 4 minúty očného kontaktu merateľne zvyšujú pocit blízkosti.' },
      { cat: 'nahrane', emoji: '💬', title: 'Jedna obava nahlas', desc: 'Povedzte partnerovi jednu obavu o váš vzťah, ktorú ste doteraz nechávali pre seba. Druhý len počúva a na koniec poďakuje.' },
      { cat: 'nahrane', emoji: '✅', title: 'Tri hodiny „áno"', desc: 'Na 3 hodiny hovoríte na (rozumné) návrhy toho druhého iba „áno". Uvidíte, kam vás to zavedie.' },
      { cat: 'nahrane', emoji: '🧭', title: 'Návod na mňa', desc: 'Napíšte si navzájom „návod na seba" — 5 bodov, ako s vami zaobchádzať, keď máte zlý deň. Vymeňte a nechajte si ho.' },
      { cat: 'nahrane', emoji: '🔥', title: 'Čo ťa priťahovalo', desc: 'Spýtajte sa: „Čo som naposledy urobil/a, čo ťa naozaj priťahovalo?" A potom to zopakujte.' },
      { cat: 'nahrane', emoji: '🗝️', title: 'Jedna nevypovedaná vec', desc: 'Prezraďte partnerovi niečo, čo ste si doteraz nechávali pre seba. Nič, čo by ublížilo — len niečo, čo ste nikdy nepovedali nahlas.' },
      { cat: 'nahrane', emoji: '⚔️', title: 'Ako sa hádame', desc: 'Povedzte si navzájom jednu vec, ktorú by ste zmenili na tom, ako spolu riešite konflikty. Druhý len počúva.' },
      { cat: 'nahrane', emoji: '💛', title: 'Desať dôvodov', desc: 'Napíšte partnerovi 10 konkrétnych vecí, prečo ste si ho vybrali. Prečítajte nahlas, pomaly.' },
      { cat: 'nahrane', emoji: '🫧', title: 'Kedy si bol/a sám/sama', desc: 'Spýtajte sa: „Kedy si sa pri mne naposledy cítil/a sám/sama?" Nevysvetľujte sa, len počúvajte a poďakujte.' },
      { cat: 'nahrane', emoji: '💶', title: 'Hodina o peniazoch', desc: 'Hodina, úprimne, čísla na papieri. Príjmy, dlhy, strachy, sny. Žiadne výčitky, len fakty a plán.', why: 'Peniaze sú téma, ktorú páry najviac obchádzajú — a najviac na nej stroskotávajú.' },
    ],
  },
  'misie': {
    slug: 'misie',
