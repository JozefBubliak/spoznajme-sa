  ...
  return (
    <Shell lang={lang}>
      <div className="space-y-8">
        ...
        {/* Local private companion workspace */}
        <div className="rounded-3xl border border-primary/20 bg-primary/5 p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-sm font-semibold text-foreground">Súkromný zápisník Nezabudni na ňu</p>
              <p className="mt-1 max-w-xl text-xs leading-relaxed text-muted-foreground">
                Ulož si dôležité dátumy, darčekové nápady, poznámky pre náročné dni a naplánuj rande.
                Zápisník zostáva iba v tvojom prehliadači.
              </p>
            </div>
            <Link
              href={`/${lang}/apps/nezabudni`}
              className="shrink-0 rounded-xl border border-primary/30 bg-primary/10 px-4 py-2.5 text-center text-xs font-semibold text-primary transition hover:bg-primary/20"
            >
              Otvoriť zápisník
            </Link>
          </div>
