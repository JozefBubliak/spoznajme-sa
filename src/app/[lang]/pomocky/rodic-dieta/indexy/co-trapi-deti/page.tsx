...
const RAW = $([regex]::Escape(tu je 75 tém, ktoré deti (od maličkých po tínedžerov) najčastejšie trápi v komunikácii s rodičmi. píšem to „hlasom dieťaťa“, aby bolo hneď jasné, kde to škrípe.

A) Byť vypočutý a braný vážne
...
Chcem poznať vaše hodnoty, ale aj priestor pre svoje otázky.)) -replace '\\r?\\n','
'
...
function parseSections(text: string): Section[] {
  ...
  for (const l of lines) {
    ...
    if (l.toLowerCase().startsWith('tu je 75')) continue
