...
const groupContent: Record<GroupKey, {
  emoji: string
  title: string
  subtitle: string
  description: string
  ...
  partneri: {
    ...
    subtitle: 'Dokázali ste spolu prejsť všetky otázky pre partnerov – krásna cesta!',
    description: 'Ale tie najhlbšie témy ešte len prídu.',
    benefits: [
      'Otázky, ktoré prehlbujú intimitu a dôveru',
      'Hlboké diskusie o hodnotách, túžbach, strachoch',
      'Zábavné a provokatívne témy, ktoré vás zbližujú'
    ]
  },
  kamarati: {
    emoji: '👫',
    title: 'Skutočné priateľstvo sa pozná v hlbokých rozhovoroch.',
    subtitle: 'Zvládol si všetky otázky pre kamarátov – skvelý začiatok!',
  ...
  rodina: {
    ...
    description: 'Stovky ďalších ti pomôžu spoznať príbehy a postoje tvojich blízkych.',
    benefits: [
      'Otázky o detstve, vďačnosti, vzťahoch medzi generáciami',
      'Témy, ktoré nikdy predtým nepadli',
  ...
  rodic_dieta: {
    ...
    subtitle: 'Zvládol(a) si všetky otázky v tejto skupine – výborne!',
    description: 'Ale tie najcennejšie rozhovory ešte len čakajú.',
    benefits: [
      'Otázky pre lepšie pochopenie sveta dieťaťa',
      'Bezpečný priestor pre emócie, sny, problémy',
      'Spolu vytvorený most dôvery'
    ]
  }
}

export default function GroupCompletionContent({ group, setGroup, user, isPaid }: GroupCompletionContentProps) {
    ...
    <div className="text-center space-y-6">
      ...
      <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-6 text-left">
        ...
        <p className="text-gray-700 mb-4 text-center">
          Spoznávanie nekončí! 🚀<br />
          Získaj neobmedzený prístup k stovkám premyslených otázok, ktoré ti pomôžu:
        </p>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {!user && (
            ...
            >
              🆓 Registrovať sa a získať 2 otázky denne
            </Button>
          )}
